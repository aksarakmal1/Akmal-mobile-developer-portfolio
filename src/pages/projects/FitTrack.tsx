...
import { ArrowLeft, ExternalLink, Github, Phone, Shield, Zap, Users, Activity } from 'lucide-react';
import { Link } from 'react-router-dom';

const FitTrack: React.FC = () => {
  const screenshots = [
    {
      url: "https://images.pexels.com/photos/3927387/pexels-photo-3927387.jpeg?auto=compress&cs=tinysrgb&w=800",
      title: "Workout Tracking"
    },
    {
      url: "https://images.pexels.com/photos/4482902/pexels-photo-4482902.jpeg?auto=compress&cs=tinysrgb&w=800",
      title: "Progress Analytics"
    },
    {
      url: "https://images.pexels.com/photos/4482900/pexels-photo-4482900.jpeg?auto=compress&cs=tinysrgb&w=800",
      title: "Social Features"
    },
    {
      url: "https://images.pexels.com/photos/4482896/pexels-photo-4482896.jpeg?auto=compress&cs=tinysrgb&w=800",
      title: "Workout Plans"
    }
  ];
  ...
  const features = [
    {
      ...
      description: "Monitor your workouts in real-time with precise metrics and voice guidance"
    },
    {
      icon: <Shield className="w-6 h-6 text-primary-600" />,
      title: "Health Integration",
      description: "Seamless integration with HealthConnect API for comprehensive health monitoring"
    },
    {
      icon: <Zap className="w-6 h-6 text-primary-600" />,
      title: "Smart Analytics",
      description: "Advanced analytics and progress tracking with visual representations"
    },
    {
      icon: <Users className="w-6 h-6 text-primary-600" />,
      title: "Social Features",
      description: "Connect with workout partners and share your fitness journey"
    }
  ];
          ...
          >
            <div>
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
                A comprehensive fitness tracking application designed to help users achieve their fitness goals through personalized workout plans, progress tracking, and detailed analytics.
              </p>
              ...
              <div className="relative w-[280px] h-[560px] mx-auto">
                <div className="absolute inset-0 bg-gradient-to-tr from-primary-600 to-primary-400 rounded-[3rem] p-3 shadow-2xl">
                  <div className="absolute inset-0 bg-gray-900 rounded-[2.5rem] overflow-hidden">
                    <img 
                      src="https://images.pexels.com/photos/3927387/pexels-photo-3927387.jpeg?auto=compress&cs=tinysrgb&w=800"
                      alt="FitTrack App Main Screen"
            ...
            <div className="lg:col-span-2">
              ...
              <div className="prose dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  FitTrack is built using modern Android development practices and the latest technologies to ensure a smooth, responsive, and maintainable application.
                </p>
                ...
                <ul className="space-y-4 text-gray-600 dark:text-gray-300">
                  <li>
                    <strong>Architecture:</strong> MVVM with Clean Architecture principles for separation of concerns and testability
                  </li>
                  <li>
                    <strong>UI Framework:</strong> Jetpack Compose with Material You design system for modern, native Android UI
                  </li>
                  <li>
                    <strong>Database:</strong> Room persistence library for robust local data storage with offline support
                  </li>
                  <li>
                    <strong>Dependency Injection:</strong> Hilt for clean, testable, and maintainable code
                  </li>
                  <li>
                    <strong>APIs:</strong> Integration with HealthConnect API and Google Fit for comprehensive health data
                  </li>
                </ul>
              </div>
            </div>
